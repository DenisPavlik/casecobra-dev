        ...
        <MaxWidthWrapper className="flex flex-col items-center gap-16 sm:gap-32">
          ...
          >
            ...
            <div className="flex flex-auto flex-col gap-4 lg:pr-8 xl:pr-20">
              ...
              <div className="text-lg leading-8">
                <p>
                  "I usually keep my phone together with my keys in the pocket
                  and that led to some pretty havy scretchmarks on all of my
                  last phone cases. This one, besides a baraly noticable scratch
                  on the corner,{" "}
                  <span className="p-0.5 bg-slate-800 text-white">
          ...
          <div className="mx-auto max-w-6xl px-6 lg:px-8">
            <div className="relative flex flex-col items-center md:grid grid-cols-2 gap-40">
              <img
                src="/arrow.png"
                alt="arrow"
                className="absolute top-[25rem] md:top-1/2 -translate-y-1/2 left-1/2 -translate-x-1/2 rotate-90
                md:rotate-0"
              />
              <div
              ...
              >
                <img
                  src="/horse.jpg"
                  alt="horse"
                  className="rounded-lg object-cover bg-white shadow-xl ring-1
